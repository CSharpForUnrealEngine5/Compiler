...
// DataprepOperationsLibrary
	...
	public void SubstituteMaterial(TArray<UObject> SelectedObjects,sbyte MaterialSearch,EEditorScriptingStringMatchType StringMatch,UObject MaterialSubstitute) {}
	public void SubstituteMaterialsByTable(TArray<UObject> SelectedObjects,UObject DataTable) {}
	public void SetLODGroup(TArray<UObject> SelectedObjects,sbyte LODGroupName,TArray<UObject> ModifiedObjects) {}
	...
	public void SubstituteMesh(TArray<UObject> SelectedObjects,sbyte MeshSearch,EEditorScriptingStringMatchType StringMatch,UObject MeshSubstitute) {}
	public void SubstituteMeshesByTable(TArray<UObject> SelectedObjects,UObject DataTable) {}
	public void AddTags(TArray<UObject> SelectedObjects,TArray<sbyte> InTags) {}
	public void AddMetadata(TArray<UObject> SelectedObjects,TMap<sbyte,sbyte> InMetadata) {}
	...
	public void SetSubOuputLevel(TArray<UObject> SelectedObjects,sbyte SubLevelName) {}
	public void SetSubOuputFolder(TArray<UObject> SelectedObjects,sbyte SubFolderName) {}
	public void AddToLayer(TArray<UObject> SelectedObjects,sbyte LayerName) {}
