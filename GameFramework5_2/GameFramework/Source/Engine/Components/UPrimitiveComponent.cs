...
// PrimitiveComponent
	...
	public bool GetGenerateOverlapEvents(bool ReturnValue) { return default; }
	...
	public bool IsExcludedFromHLODLevel(EHLODLevelExclusion HLODLevel,bool ReturnValue) { return default; }
	...
	public TArray<int> GetExcludeForSpecificHLODLevels(TArray<int> ReturnValue) { return default; }
	...
	public void IgnoreActorWhenMoving(UObject Actor,bool bShouldIgnore) {}
	public TArray<UObject> CopyArrayOfMoveIgnoreActors(TArray<UObject> ReturnValue) { return default; }
	public void ClearMoveIgnoreActors() {}
	public TArray<UPrimitiveComponent> MoveIgnoreComponents;
	public void IgnoreComponentWhenMoving(UObject Component,bool bShouldIgnore) {}
	public TArray<UObject> CopyArrayOfMoveIgnoreComponents(TArray<UObject> ReturnValue) { return default; }
	public void ClearMoveIgnoreComponents() {}
	public int GetCustomPrimitiveDataIndexForScalarParameter(sbyte ParameterName,int ReturnValue) { return default; }
	public int GetCustomPrimitiveDataIndexForVectorParameter(sbyte ParameterName,int ReturnValue) { return default; }
	public void SetScalarParameterForCustomPrimitiveData(sbyte ParameterName,float Value) {}
	public void SetVectorParameterForCustomPrimitiveData(sbyte ParameterName,FVector4 Value) {}
	...
	public void SetScalarParameterForDefaultCustomPrimitiveData(sbyte ParameterName,float Value) {}
	public void SetVectorParameterForDefaultCustomPrimitiveData(sbyte ParameterName,FVector4 Value) {}
	...
	public bool IsOverlappingComponent(UObject OtherComp,bool ReturnValue) { return default; }
	...
	public void GetOverlappingComponents(TArray<UObject> OutOverlappingComponents) {}
	...
	public void SetBoundsScale(float NewBoundsScale=1.f) {}
	public UObject GetMaterial(int ElementIndex,UObject ReturnValue) { return default; }
	public void SetMaterial(int ElementIndex,UObject Material) {}
	public void SetMaterialByName(sbyte MaterialSlotName,UObject Material) {}
	public UObject CreateAndSetMaterialInstanceDynamic(int ElementIndex,UObject ReturnValue) { return default; }
	public UObject CreateAndSetMaterialInstanceDynamicFromMaterial(int ElementIndex,UObject Parent,UObject ReturnValue) { return default; }
	public UObject CreateDynamicMaterialInstance(int ElementIndex,UObject SourceMaterial=NULL,sbyte OptionalName=NAME_None,UObject ReturnValue) { return default; }
	public UObject GetMaterialFromCollisionFaceIndex(int FaceIndex,int SectionIndex,UObject ReturnValue) { return default; }
	public FWalkableSlopeOverride GetWalkableSlopeOverride(FWalkableSlopeOverride ReturnValue) { return default; }
	...
	public bool GetStaticWhenNotMoveable(bool ReturnValue) { return default; }
	public void SetConstraintMode(EDOFMode ConstraintMode) {}
	public void AddImpulse(FVector Impulse,sbyte BoneName=NAME_None,bool bVelChange=false) {}
	public void AddAngularImpulseInRadians(FVector Impulse,sbyte BoneName=NAME_None,bool bVelChange=false) {}
	public void AddAngularImpulseInDegrees(FVector Impulse,sbyte BoneName=NAME_None,bool bVelChange=false) {}
	public void AddImpulseAtLocation(FVector Impulse,FVector Location,sbyte BoneName=NAME_None) {}
	public void AddVelocityChangeImpulseAtLocation(FVector Impulse,FVector Location,sbyte BoneName=NAME_None) {}
	...
	public void AddForce(FVector Force,sbyte BoneName=NAME_None,bool bAccelChange=false) {}
	public void AddForceAtLocation(FVector Force,FVector Location,sbyte BoneName=NAME_None) {}
	public void AddForceAtLocationLocal(FVector Force,FVector Location,sbyte BoneName=NAME_None) {}
	...
	public void AddTorqueInRadians(FVector Torque,sbyte BoneName=NAME_None,bool bAccelChange=false) {}
	public void AddTorqueInDegrees(FVector Torque,sbyte BoneName=NAME_None,bool bAccelChange=false) {}
	public void SetPhysicsLinearVelocity(FVector NewVel,bool bAddToCurrent=false,sbyte BoneName=NAME_None) {}
	public FVector GetPhysicsLinearVelocity(sbyte BoneName=NAME_None,FVector ReturnValue) { return default; }
	public FVector GetPhysicsLinearVelocityAtPoint(FVector Point,sbyte BoneName=NAME_None,FVector ReturnValue) { return default; }
	public void SetAllPhysicsLinearVelocity(FVector NewVel,bool bAddToCurrent=false) {}
	public void SetPhysicsAngularVelocityInRadians(FVector NewAngVel,bool bAddToCurrent=false,sbyte BoneName=NAME_None) {}
	public void SetPhysicsAngularVelocityInDegrees(FVector NewAngVel,bool bAddToCurrent=false,sbyte BoneName=NAME_None) {}
	public void SetPhysicsMaxAngularVelocityInDegrees(float NewMaxAngVel,bool bAddToCurrent=false,sbyte BoneName=NAME_None) {}
	public void SetPhysicsMaxAngularVelocityInRadians(float NewMaxAngVel,bool bAddToCurrent=false,sbyte BoneName=NAME_None) {}
	public FVector GetPhysicsAngularVelocityInDegrees(sbyte BoneName=NAME_None,FVector ReturnValue) { return default; }
	public FVector GetPhysicsAngularVelocityInRadians(sbyte BoneName=NAME_None,FVector ReturnValue) { return default; }
	public FVector GetCenterOfMass(sbyte BoneName=NAME_None,FVector ReturnValue) { return default; }
	public void SetCenterOfMass(FVector CenterOfMassOffset,sbyte BoneName=NAME_None) {}
	public void WakeRigidBody(sbyte BoneName=NAME_None) {}
	public void PutRigidBodyToSleep(sbyte BoneName=NAME_None) {}
	...
	public void SetCollisionProfileName(sbyte InCollisionProfileName,bool bUpdateOverlaps=true) {}
	public sbyte GetCollisionProfileName(sbyte ReturnValue) { return default; }
	public void SetCollisionObjectType(ECollisionChannel Channel) {}
	public bool K2_LineTraceComponent(FVector TraceStart,FVector TraceEnd,bool bTraceComplex,bool bShowTrace,bool bPersistentShowTrace,FVector HitLocation,FVector HitNormal,sbyte BoneName,FHitResult OutHit,bool ReturnValue) { return default; }
	public bool K2_SphereTraceComponent(FVector TraceStart,FVector TraceEnd,float SphereRadius,bool bTraceComplex,bool bShowTrace,bool bPersistentShowTrace,FVector HitLocation,FVector HitNormal,sbyte BoneName,FHitResult OutHit,bool ReturnValue) { return default; }
	public bool K2_BoxOverlapComponent(FVector InBoxCentre,FBox InBox,bool bTraceComplex,bool bShowTrace,bool bPersistentShowTrace,FVector HitLocation,FVector HitNormal,sbyte BoneName,FHitResult OutHit,bool ReturnValue) { return default; }
	public bool K2_SphereOverlapComponent(FVector InSphereCentre,float InSphereRadius,bool bTraceComplex,bool bShowTrace,bool bPersistentShowTrace,FVector HitLocation,FVector HitNormal,sbyte BoneName,FHitResult OutHit,bool ReturnValue) { return default; }
	...
	public int GetNumMaterials(int ReturnValue) { return default; }
	public FBodyInstanceAsyncPhysicsTickHandle GetBodyInstanceAsyncPhysicsTickHandle(sbyte BoneName=NAME_None,bool bGetWelded=true,int Index=-1,FBodyInstanceAsyncPhysicsTickHandle ReturnValue) { return default; }
	public float GetClosestPointOnCollision(FVector Point,FVector OutPointOnBody,sbyte BoneName=NAME_None,float ReturnValue) { return default; }
	public ECollisionEnabled GetCollisionEnabled(ECollisionEnabled ReturnValue) { return default; }
	public bool K2_IsCollisionEnabled(bool ReturnValue) { return default; }
	public bool K2_IsQueryCollisionEnabled(bool ReturnValue) { return default; }
	public bool K2_IsPhysicsCollisionEnabled(bool ReturnValue) { return default; }
	public ECollisionResponse GetCollisionResponseToChannel(ECollisionChannel Channel,ECollisionResponse ReturnValue) { return default; }
	public ECollisionChannel GetCollisionObjectType(ECollisionChannel ReturnValue) { return default; }
	...
	public bool IsGravityEnabled(bool ReturnValue) { return default; }
	public void SetLinearDamping(float InDamping) {}
	public float GetLinearDamping(float ReturnValue) { return default; }
	public void SetAngularDamping(float InDamping) {}
	public float GetAngularDamping(float ReturnValue) { return default; }
	public void SetMassScale(sbyte BoneName=NAME_None,float InMassScale=1.f) {}
	public float GetMassScale(sbyte BoneName=NAME_None,float ReturnValue) { return default; }
	public void SetAllMassScale(float InMassScale=1.f) {}
	public void SetMassOverrideInKg(sbyte BoneName=NAME_None,float MassInKg=1.f,bool bOverrideMass=true) {}
	public float GetMass(float ReturnValue) { return default; }
	public FVector GetInertiaTensor(sbyte BoneName=NAME_None,FVector ReturnValue) { return default; }
	public FVector ScaleByMomentOfInertia(FVector InputVector,sbyte BoneName=NAME_None,FVector ReturnValue) { return default; }
	public void SetUseCCD(bool InUseCCD,sbyte BoneName=NAME_None) {}
	public void SetAllUseCCD(bool InUseCCD) {}
	public bool IsAnyRigidBodyAwake(bool ReturnValue) { return default; }
	...
	public void SetPhysMaterialOverride(UObject NewPhysMaterial) {}
	public void SetCullDistance(float NewCullDistance) {}
	public bool CanCharacterStepUp(UObject Pawn,bool ReturnValue) { return default; }
}
