...
// LidarPointCloudBlueprintLibrary
	public UObject CreatePointCloudEmpty(UObject ReturnValue) { return default; }
	public void CreatePointCloudFromFile(UObject WorldContextObject,sbyte Filename,bool bUseAsync,FLatentActionInfo LatentInfo,ELidarPointCloudAsyncMode AsyncMode,float Progress,UObject PointCloud) {}
	...
	public bool ExportPointCloudToFile(UObject PointCloud,sbyte Filename,bool ReturnValue) { return default; }
	public void AlignClouds(TArray<UObject> PointCloudsToAlign) {}
	public bool ArePointsInSphere(UObject WorldContextObject,FVector Center,float Radius,bool bVisibleOnly,bool ReturnValue) { return default; }
	public bool ArePointsInBox(UObject WorldContextObject,FVector Center,FVector Extent,bool bVisibleOnly,bool ReturnValue) { return default; }
	public bool ArePointsByRay(UObject WorldContextObject,FVector Origin,FVector Direction,float Radius,bool bVisibleOnly,bool ReturnValue) { return default; }
	...
	public bool LineTraceSingle(UObject WorldContextObject,FVector Origin,FVector Direction,float Radius,bool bVisibleOnly,FLidarPointCloudTraceHit Hit,bool ReturnValue) { return default; }
	public bool LineTraceMulti(UObject WorldContextObject,FVector Origin,FVector Direction,float Radius,bool bVisibleOnly,TArray<FLidarPointCloudTraceHit> Hits,bool ReturnValue) { return default; }
	...
	public FVector Conv_LidarPointCloudNormalToVector(FLidarPointCloudNormal Normal,FVector ReturnValue) { return default; }
	public FLidarPointCloudNormal Conv_VectorToLidarPointCloudNormal(FVector Vector,FLidarPointCloudNormal ReturnValue) { return default; }
}
