...
// RadialIntMask
	public UObject SetRadialIntMask(float Radius,FVector Position,int InteriorValue,int ExteriorValue,ESetMaskConditionType SetMaskConditionIn,UObject ReturnValue) { return default; }
	public float Radius;
