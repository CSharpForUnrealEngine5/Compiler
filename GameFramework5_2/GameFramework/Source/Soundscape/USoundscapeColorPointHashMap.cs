...
// SoundscapeColorPointHashMap
	...
	public int NumColorPointsInCell(FVector Location,FGameplayTag ColorPoint,int ReturnValue) { return default; }
	public bool AddColorPointToHash(FVector Location,FGameplayTag ColorPoint,bool ReturnValue) { return default; }
	public void AddColorPointArrayToHash(TArray<FVector> Locations,FGameplayTag ColorPoint) {}
	public ulong CalculateHashIndex(FVector Location,ulong ReturnValue) { return default; }
